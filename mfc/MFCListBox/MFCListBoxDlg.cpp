...
// MFCListBoxDlg.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CMFCListBoxDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCListBoxDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMFCListBoxDlg::OnBnClickedButton2)
	ON_LBN_SELCHANGE(IDC_LIST1, &CMFCListBoxDlg::OnLbnSelchangeList1)
	ON_BN_CLICKED(IDC_BUTTON3, &CMFCListBoxDlg::OnBnClickedButton3)
END_MESSAGE_MAP()


// CMFCListBoxDlg message handlers
...
void CMFCListBoxDlg::OnBnClickedButton1()
{
	...
	{
		MessageBox(TEXT("Content cannot be empty!"));
		return;
	}
...
void CMFCListBoxDlg::OnBnClickedButton3()
{
	...
	m_listBox.InsertString(index, m_str);
