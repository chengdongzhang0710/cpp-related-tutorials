...
// MFCListBox.cpp : Defines the class behaviors for the application.
//
...
// The one and only CMFCListBoxApp object

CMFCListBoxApp theApp;


// CMFCListBoxApp initialization
